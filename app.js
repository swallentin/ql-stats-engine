...
MongoClient.connect(url, function (err, db) {
    ...
    settings.servers.forEach(function (server)  {
        ...
        socket.on('connect', function(fd, ep) { handleMonitorEvent( server, 'connect', fd, ep ); });
        socket.on('connect_delay', function(fd, ep) { handleMonitorEvent( server, 'connect_delay', fd, ep ); });
        socket.on('connect_retry', function(fd, ep) { handleMonitorEvent( server, 'connect_retry', fd, ep ); });
        socket.on('listen', function(fd, ep) { handleMonitorEvent( server, 'listen', fd, ep ); });
        socket.on('bind_error', function(fd, ep) { handleMonitorEvent( server, 'bind_error', fd, ep ); });
        socket.on('accept', function(fd, ep) { handleMonitorEvent( server, 'accept', fd, ep ); });
        socket.on('accept_error', function(fd, ep) { handleMonitorEvent( server, 'accept_error', fd, ep ); });
        socket.on('close', function(fd, ep) { handleMonitorEvent( server, 'close', fd, ep ); });
        socket.on('close_error', function(fd, ep) { handleMonitorEvent( server, 'close_error', fd, ep ); });
        socket.on('disconnect', function(fd, ep) { handleMonitorEvent( server, 'disconnect', fd, ep ); });
